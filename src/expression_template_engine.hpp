...
class expression_template_storage_engine : public storage_engine<ValT, CfgT>
{
public:
...
public:
    ...
    bool is_trivial()const{return detail::is_trivial(host()->size(),operands());}
};
...
//     using root_type = evaluating_tensor<ValT,CfgT,F,Ops...>;
...
//     expression_template_elementwise_engine(const root_type* root__):
//         root_{root__}
//     {}
