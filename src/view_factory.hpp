...
public:
    ...
    static auto create_view_slice(const std::shared_ptr<ImplT>& parent, const slices_collection_type& subs){
        using impl_type = view_slice<typename detail::viewing_engine_traits<typename CfgT::host_engine, ValT, CfgT, view_slice_descriptor_type, ImplT>::type>;
    ...
    static auto create_view_subdim(const std::shared_ptr<ImplT>& parent, const shape_type& subs){
        using impl_type = view_subdim<typename detail::viewing_engine_traits<typename CfgT::host_engine, ValT, CfgT, view_subdim_descriptor_type, ImplT>::type>;
    ...
    static auto create_view_reshape(const std::shared_ptr<ImplT>& parent, const shape_type& subs){
        using impl_type = view_reshape<typename detail::viewing_engine_traits<typename CfgT::host_engine, ValT, CfgT, view_reshape_descriptor_type, ImplT>::type>;
    ...
    static auto create_mapping_view_index_tensor(const std::shared_ptr<ImplT>& parent, const Subs&...subs){
        using impl_type = mapping_view<typename detail::viewing_engine_traits<typename CfgT::host_engine, ValT, CfgT, mapping_view_descriptor_type, ImplT>::type>;
