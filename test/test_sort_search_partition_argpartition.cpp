...
//partition
TEST_CASE("test_sort_search_partition","[test_sort_search]")
{
    using value_type = double;
    using tensor_type = gtensor::tensor<value_type>;
...
TEST_CASE("test_sort_search_partition_overload_default_policy","[test_sort_search]")
{
    ...
    //default comparator
    REQUIRE(is_partitioned(partition(tensor_type{{2,1,-1,6,3},{8,2,1,0,5},{-1,7,0,4,2},{4,4,2,1,4},{3,1,6,4,3}},3,0),0,3,std::less<void>{}));
    REQUIRE(is_partitioned(partition(tensor_type{{2,1,-1,6,3},{8,2,1,0,5},{-1,7,0,4,2},{4,4,2,1,4},{3,1,6,4,3}},std::vector<int>{1,3},0),0,std::vector<int>{1,3},std::less<void>{}));
    //default comparator, axis
    REQUIRE(is_partitioned(partition(tensor_type{{2,1,-1,6,3},{8,2,1,0,5},{-1,7,0,4,2},{4,4,2,1,4},{3,1,6,4,3}},3),1,3,std::less<void>{}));
    REQUIRE(is_partitioned(partition(tensor_type{{2,1,-1,6,3},{8,2,1,0,5},{-1,7,0,4,2},{4,4,2,1,4},{3,1,6,4,3}},std::vector<int>{1,3}),1,std::vector<int>{1,3},std::less<void>{}));
}
...
)
{
    ...
    //default comparator
    REQUIRE(is_partitioned(partition(policy{},tensor_type{{2,1,-1,6,3},{8,2,1,0,5},{-1,7,0,4,2},{4,4,2,1,4},{3,1,6,4,3}},3,0),0,3,std::less<void>{}));
    REQUIRE(is_partitioned(partition(policy{},tensor_type{{2,1,-1,6,3},{8,2,1,0,5},{-1,7,0,4,2},{4,4,2,1,4},{3,1,6,4,3}},std::vector<int>{1,3},0),0,std::vector<int>{1,3},std::less<void>{}));
    //default comparator, axis
    REQUIRE(is_partitioned(partition(policy{},tensor_type{{2,1,-1,6,3},{8,2,1,0,5},{-1,7,0,4,2},{4,4,2,1,4},{3,1,6,4,3}},3),1,3,std::less<void>{}));
    REQUIRE(is_partitioned(partition(policy{},tensor_type{{2,1,-1,6,3},{8,2,1,0,5},{-1,7,0,4,2},{4,4,2,1,4},{3,1,6,4,3}},std::vector<int>{1,3}),1,std::vector<int>{1,3},std::less<void>{}));
}
