...
//     constexpr std::size_t bench_iterations = 100;
...
)
{
    ...
    for (auto it=shapes.begin(), last=shapes.end(); it!=last; ++it){
        ...
        total+=bench_iterator(t,traverse_order{},"iterator");
        //total+=bench_iterator_no_deref(t,traverse_order{},"iterator no deref");
    }
