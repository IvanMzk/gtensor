...
TEST_CASE("test_tensor_swap","[test_tensor]")
{
    ...
    auto test = [](const auto& t){
        ...
        auto ten1_shallow_clone = ten1.clone_shallow();
        auto ten2_shallow_clone = ten2.clone_shallow();
        REQUIRE(ten1_shallow_clone.is_same(ten1));
        REQUIRE(ten2_shallow_clone.is_same(ten2));
        swap(ten1,ten2);
        REQUIRE(ten1.is_same(ten2_shallow_clone));
        REQUIRE(ten2.is_same(ten1_shallow_clone));
