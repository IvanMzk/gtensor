...
TEMPLATE_TEST_CASE("test_make_dividers", "[test_libdivide_helper]", std::int64_t, gtensor::integral<std::int64_t>)
{
...
TEMPLATE_TEST_CASE("test_divide", "[test_libdivide_helper]", std::int64_t, gtensor::integral<std::int64_t>)
{
    using value_type = TestType;
    using libdivide_divider_type =  gtensor::detail::libdivide_divider<value_type>;
