...
TEST_CASE("test_walker_random_access_traverser","test_data_accessor")
{
    ...
    auto test_data = std::make_tuple(
        ...
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, [](auto& tr){return tr.to(0), true;}, shape_type{0,0,0}, value_type{1}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, [](auto& tr){return tr.to(1), true;}, shape_type{0,0,1}, value_type{2}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, [](auto& tr){return tr.to(5), true;}, shape_type{0,2,1}, value_type{6}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, [](auto& tr){return tr.to(8), true;}, shape_type{1,1,0}, value_type{9}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, [](auto& tr){return tr.to(11), true;}, shape_type{1,2,1}, value_type{12}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, [](auto& tr){return tr.to(5),tr.next();}, shape_type{1,0,0}, value_type{7}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, [](auto& tr){return tr.to(11),tr.next();}, shape_type{0,0,0}, value_type{1}, false),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, [](auto& tr){return tr.to(5),tr.prev();}, shape_type{0,2,0}, value_type{5}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, [](auto& tr){return tr.to_last(),tr.to(7),true;}, shape_type{1,0,1}, value_type{8}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, [](auto& tr){return tr.to(7),tr.to_last(),true;}, shape_type{1,2,1}, value_type{12}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, [](auto& tr){return tr.prev(),tr.to(3),true;}, shape_type{0,1,1}, value_type{4}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, [](auto& tr){return tr.next(),tr.to(3),true;}, shape_type{0,1,1}, value_type{4}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, [](auto& tr){return tr.next(),tr.to(6),tr.next(),true;}, shape_type{1,0,1}, value_type{8}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, [](auto& tr){return tr.next(),tr.to(8),tr.next(),true;}, shape_type{1,1,1}, value_type{10}, true),
        //elements in c_order, traverse f_order
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, [](auto& tr){return tr.to(0), true;}, shape_type{0,0,0}, value_type{1}, true),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, [](auto& tr){return tr.to(1), true;}, shape_type{1,0,0}, value_type{7}, true),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, [](auto& tr){return tr.to(5), true;}, shape_type{1,2,0}, value_type{11}, true),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, [](auto& tr){return tr.to(8), true;}, shape_type{0,1,1}, value_type{4}, true),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, [](auto& tr){return tr.to(11), true;}, shape_type{1,2,1}, value_type{12}, true),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, [](auto& tr){return tr.to(5),tr.next();}, shape_type{0,0,1}, value_type{2}, true),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, [](auto& tr){return tr.to(11),tr.next();}, shape_type{0,0,0}, value_type{1}, false),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, [](auto& tr){return tr.to(5),tr.prev();}, shape_type{0,2,0}, value_type{5}, true),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, [](auto& tr){return tr.to_last(),tr.to(7),true;}, shape_type{1,0,1}, value_type{8}, true),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, [](auto& tr){return tr.to(7),tr.to_last(),true;}, shape_type{1,2,1}, value_type{12}, true),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, [](auto& tr){return tr.prev(),tr.to(3),true;}, shape_type{1,1,0}, value_type{9}, true),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, [](auto& tr){return tr.next(),tr.to(3),true;}, shape_type{1,1,0}, value_type{9}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, [](auto& tr){return tr.next(),tr.to(6),tr.next(),true;}, shape_type{1,0,1}, value_type{8}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, [](auto& tr){return tr.next(),tr.to(8),tr.next(),true;}, shape_type{1,1,1}, value_type{10}, true),
        //elements in f_order, traverse c_order
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, [](auto& tr){return tr.to(0), true;}, shape_type{0,0,0}, value_type{1}, true),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, [](auto& tr){return tr.to(1), true;}, shape_type{0,0,1}, value_type{2}, true),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, [](auto& tr){return tr.to(5), true;}, shape_type{0,2,1}, value_type{6}, true),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, [](auto& tr){return tr.to(8), true;}, shape_type{1,1,0}, value_type{9}, true),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, [](auto& tr){return tr.to(11), true;}, shape_type{1,2,1}, value_type{12}, true),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, [](auto& tr){return tr.to(5),tr.next();}, shape_type{1,0,0}, value_type{7}, true),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, [](auto& tr){return tr.to(11),tr.next();}, shape_type{0,0,0}, value_type{1}, false),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, [](auto& tr){return tr.to(5),tr.prev();}, shape_type{0,2,0}, value_type{5}, true),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, [](auto& tr){return tr.to_last(),tr.to(7),true;}, shape_type{1,0,1}, value_type{8}, true),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, [](auto& tr){return tr.to(7),tr.to_last(),true;}, shape_type{1,2,1}, value_type{12}, true),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, [](auto& tr){return tr.prev(),tr.to(3),true;}, shape_type{0,1,1}, value_type{4}, true),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, [](auto& tr){return tr.next(),tr.to(3),true;}, shape_type{0,1,1}, value_type{4}, true),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, [](auto& tr){return tr.next(),tr.to(6),tr.next(),true;}, shape_type{1,0,1}, value_type{8}, true),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, [](auto& tr){return tr.next(),tr.to(8),tr.next(),true;}, shape_type{1,1,1}, value_type{10}, true),
        //elements in f_order, traverse f_order
        std::make_tuple(f_order{}, f_order{}, storage_f, shape, [](auto& tr){return tr.to(0), true;}, shape_type{0,0,0}, value_type{1}, true),
        std::make_tuple(f_order{}, f_order{}, storage_f, shape, [](auto& tr){return tr.to(1), true;}, shape_type{1,0,0}, value_type{7}, true),
        std::make_tuple(f_order{}, f_order{}, storage_f, shape, [](auto& tr){return tr.to(5), true;}, shape_type{1,2,0}, value_type{11}, true),
        std::make_tuple(f_order{}, f_order{}, storage_f, shape, [](auto& tr){return tr.to(8), true;}, shape_type{0,1,1}, value_type{4}, true),
        std::make_tuple(f_order{}, f_order{}, storage_f, shape, [](auto& tr){return tr.to(11), true;}, shape_type{1,2,1}, value_type{12}, true),
        std::make_tuple(f_order{}, f_order{}, storage_f, shape, [](auto& tr){return tr.to(5),tr.next();}, shape_type{0,0,1}, value_type{2}, true),
        std::make_tuple(f_order{}, f_order{}, storage_f, shape, [](auto& tr){return tr.to(11),tr.next();}, shape_type{0,0,0}, value_type{1}, false),
        std::make_tuple(f_order{}, f_order{}, storage_f, shape, [](auto& tr){return tr.to(5),tr.prev();}, shape_type{0,2,0}, value_type{5}, true),
        std::make_tuple(f_order{}, f_order{}, storage_f, shape, [](auto& tr){return tr.to_last(),tr.to(7),true;}, shape_type{1,0,1}, value_type{8}, true),
        std::make_tuple(f_order{}, f_order{}, storage_f, shape, [](auto& tr){return tr.to(7),tr.to_last(),true;}, shape_type{1,2,1}, value_type{12}, true),
        std::make_tuple(f_order{}, f_order{}, storage_f, shape, [](auto& tr){return tr.prev(),tr.to(3),true;}, shape_type{1,1,0}, value_type{9}, true),
        std::make_tuple(f_order{}, f_order{}, storage_f, shape, [](auto& tr){return tr.next(),tr.to(3),true;}, shape_type{1,1,0}, value_type{9}, true),
        std::make_tuple(f_order{}, f_order{}, storage_f, shape, [](auto& tr){return tr.next(),tr.to(6),tr.next(),true;}, shape_type{1,0,1}, value_type{8}, true),
        std::make_tuple(f_order{}, f_order{}, storage_f, shape, [](auto& tr){return tr.next(),tr.to(8),tr.next(),true;}, shape_type{1,1,1}, value_type{10}, true)
    );
    auto test = [](const auto& t){
        auto elements_order = std::get<0>(t);
...
TEST_CASE("test_walker_random_access_traverser_range","test_data_accessor")
{
    using value_type = int;
    using config_type = gtensor::config::extend_config_t<test_config::config_storage_selector_t<std::vector>,value_type>;
    using shape_type = typename config_type::shape_type;
    ...
    //0elements_order,1traverse_order,2storage,3shape,4axes,5axes_map,6command,7expected_index,8expected_element
    auto test_data = std::make_tuple(
        //elements in c_order
        //traverse direction 1 c_order,c_order
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, axes_type{1}, axes_type{1,0,2}, [](auto& tr){return tr.to(0),true;}, shape_type{0,0,0}, value_type{1}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, axes_type{1}, axes_type{1,0,2}, [](auto& tr){return tr.next(),tr.to(0),true;}, shape_type{0,0,0}, value_type{1}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, axes_type{1}, axes_type{1,0,2}, [](auto& tr){return tr.to(0),tr.next();}, shape_type{1,0,0}, value_type{5}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, axes_type{1}, axes_type{1,0,2}, [](auto& tr){return tr.next(),tr.to(0),tr.next();}, shape_type{1,0,0}, value_type{5}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, axes_type{1}, axes_type{1,0,2}, [](auto& tr){return tr.to(0),tr.prev();}, shape_type{2,0,0}, value_type{9}, false),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, axes_type{1}, axes_type{1,0,2}, [](auto& tr){return tr.to(1),true;}, shape_type{1,0,0}, value_type{5}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, axes_type{1}, axes_type{1,0,2}, [](auto& tr){return tr.to(1),tr.next();}, shape_type{2,0,0}, value_type{9}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, axes_type{1}, axes_type{1,0,2}, [](auto& tr){return tr.to(1),tr.prev();}, shape_type{0,0,0}, value_type{1}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, axes_type{1}, axes_type{1,0,2}, [](auto& tr){return tr.to(2),true;}, shape_type{2,0,0}, value_type{9}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, axes_type{1}, axes_type{1,0,2}, [](auto& tr){return tr.to(2),tr.next();}, shape_type{0,0,0}, value_type{1}, false),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, axes_type{1}, axes_type{1,0,2}, [](auto& tr){return tr.to(2),tr.prev();}, shape_type{1,0,0}, value_type{5}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, axes_type{1}, axes_type{1,0,2}, [](auto& tr){return tr.to(2),tr.prev();}, shape_type{1,0,0}, value_type{5}, true),
        //traverse direction 0,2 c_order,f_order
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.to(0),true;}, shape_type{0,0,0}, value_type{1}, true),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.next(),tr.to(0),true;}, shape_type{0,0,0}, value_type{1}, true),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.to(0),tr.next();}, shape_type{1,0,0}, value_type{13}, true),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.next(),tr.to(0),tr.next();}, shape_type{1,0,0}, value_type{13}, true),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.to(0),tr.prev();}, shape_type{1,3,0}, value_type{16}, false),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.to(1),true;}, shape_type{1,0,0}, value_type{13}, true),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.to(4),true;}, shape_type{0,2,0}, value_type{3}, true),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.to(7),true;}, shape_type{1,3,0}, value_type{16}, true),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.to(7),tr.prev();}, shape_type{0,3,0}, value_type{4}, true),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.to(7),tr.next();}, shape_type{0,0,0}, value_type{1}, false),
        //traverse direction 0,2 f_order,c_order
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.to(0),true;}, shape_type{0,0,0}, value_type{1}, true),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.next(),tr.to(0),true;}, shape_type{0,0,0}, value_type{1}, true),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.to(0),tr.next();}, shape_type{0,1,0}, value_type{2}, true),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.next(),tr.to(0),tr.next();}, shape_type{0,1,0}, value_type{2}, true),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.to(0),tr.prev();}, shape_type{1,3,0}, value_type{16}, false),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.to(1),true;}, shape_type{0,1,0}, value_type{2}, true),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.to(4),true;}, shape_type{1,0,0}, value_type{13}, true),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.to(7),true;}, shape_type{1,3,0}, value_type{16}, true),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.to(7),tr.prev();}, shape_type{1,2,0}, value_type{15}, true),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.to(7),tr.next();}, shape_type{0,0,0}, value_type{1}, false)
    );
    auto test = [](const auto& t){
        auto elements_order = std::get<0>(t);
        ...
        auto storage = std::get<2>(t);
        auto shape = std::get<3>(t);
        auto axes = std::get<4>(t);
        auto axes_map = std::get<5>(t);
        auto command = std::get<6>(t);
        auto expected_index = std::get<7>(t);
        auto expected_element = std::get<8>(t);
        auto expected_is_next = std::get<9>(t);
        auto indexer = indexer_type{storage};
        auto strides = make_strides(shape, elements_order);
        auto adapted_strides = make_adapted_strides(shape,strides);
        auto reset_strides = make_reset_strides(shape,strides);
        ...
        auto traverser_shape = make_range_traverser_shape(shape,axes_map);
        auto traverser_strides_div = make_range_traverser_strides_div<config_type>(traverser_shape,axes.size(),traverse_order);
        //traverse axes range should be in terms of permuted axes e.g. given axes, axes range is [0,axes.size()), complement axes range is [axes.size(),dim)
        auto traverser = traverser_type{traverser_shape, traverser_strides_div, walker,dim_type{0}, axes.size()};
        auto result_is_next = command(traverser);
        auto result_index = traverser.index();
        auto result_element = *traverser.walker();
        REQUIRE(result_is_next == expected_is_next);
