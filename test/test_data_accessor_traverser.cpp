...
TEST_CASE("test_walker_random_access_traverser_range","test_data_accessor")
{
    ...
    auto test_data = std::make_tuple(
        ...
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, axes_type{1}, axes_type{1,0,2}, [](auto& tr){return tr.move(0),true;}, shape_type{0,0,0}, value_type{1}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, axes_type{1}, axes_type{1,0,2}, [](auto& tr){return tr.move(0),tr.next();}, shape_type{1,0,0}, value_type{5}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, axes_type{1}, axes_type{1,0,2}, [](auto& tr){return tr.move(0),tr.prev();}, shape_type{2,0,0}, value_type{9}, false),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, axes_type{1}, axes_type{1,0,2}, [](auto& tr){return tr.move(1),true;}, shape_type{1,0,0}, value_type{5}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, axes_type{1}, axes_type{1,0,2}, [](auto& tr){return tr.move(1),tr.next();}, shape_type{2,0,0}, value_type{9}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, axes_type{1}, axes_type{1,0,2}, [](auto& tr){return tr.move(1),tr.prev();}, shape_type{0,0,0}, value_type{1}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, axes_type{1}, axes_type{1,0,2}, [](auto& tr){return tr.move(2),true;}, shape_type{2,0,0}, value_type{9}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, axes_type{1}, axes_type{1,0,2}, [](auto& tr){return tr.move(2),tr.next();}, shape_type{0,0,0}, value_type{1}, false),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, axes_type{1}, axes_type{1,0,2}, [](auto& tr){return tr.move(2),tr.prev();}, shape_type{1,0,0}, value_type{5}, true),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape, axes_type{1}, axes_type{1,0,2}, [](auto& tr){return tr.move(2),tr.prev();}, shape_type{1,0,0}, value_type{5}, true),
        //traverse direction 0,2 c_order,f_order
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.move(0),true;}, shape_type{0,0,0}, value_type{1}, true),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.move(0),tr.next();}, shape_type{1,0,0}, value_type{13}, true),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.move(0),tr.prev();}, shape_type{1,3,0}, value_type{16}, false),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.move(1),true;}, shape_type{1,0,0}, value_type{13}, true),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.move(4),true;}, shape_type{0,2,0}, value_type{3}, true),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.move(7),true;}, shape_type{1,3,0}, value_type{16}, true),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.move(7),tr.prev();}, shape_type{0,3,0}, value_type{4}, true),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.move(7),tr.next();}, shape_type{0,0,0}, value_type{1}, false),
        //traverse direction 0,2 f_order,c_order
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.move(0),true;}, shape_type{0,0,0}, value_type{1}, true),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.move(0),tr.next();}, shape_type{0,1,0}, value_type{2}, true),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.move(0),tr.prev();}, shape_type{1,3,0}, value_type{16}, false),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.move(1),true;}, shape_type{0,1,0}, value_type{2}, true),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.move(4),true;}, shape_type{1,0,0}, value_type{13}, true),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.move(7),true;}, shape_type{1,3,0}, value_type{16}, true),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.move(7),tr.prev();}, shape_type{1,2,0}, value_type{15}, true),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape, axes_type{0,2}, axes_type{0,2,1}, [](auto& tr){return tr.move(7),tr.next();}, shape_type{0,0,0}, value_type{1}, false)
    );
    auto test = [](const auto& t){
        auto elements_order = std::get<0>(t);
