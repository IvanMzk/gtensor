...
TEST_CASE("test_broadcast_iterator_traverse","[test_iterator]")
{
    ...
    auto test_data = std::make_tuple(
        ...
        std::make_tuple(c_order{}, c_order{}, storage_c, shape_type{6}, shape_type{6,1}, std::vector<value_type>{1,1,1,1,1,1}),
        ...
        std::make_tuple(c_order{}, c_order{}, storage_c, shape_type{2,3}, shape_type{1,3}, std::vector<value_type>{1,2,3}),
        std::make_tuple(c_order{}, c_order{}, storage_c, shape_type{2,3}, shape_type{3,1,3}, std::vector<value_type>{1,2,3,1,2,3,1,2,3}),
        //traverse f_order
        ...
        std::make_tuple(c_order{}, f_order{}, storage_c, shape_type{6}, shape_type{6,1}, std::vector<value_type>{1,1,1,1,1,1}),
        ...
        std::make_tuple(c_order{}, f_order{}, storage_c, shape_type{2,3}, shape_type{1,3}, std::vector<value_type>{1,2,3}),
        std::make_tuple(c_order{}, f_order{}, storage_c, shape_type{2,3}, shape_type{3,1,3}, std::vector<value_type>{1,1,1,2,2,2,3,3,3}),
        //elements in f_order
        //traverse c_order
        ...
        std::make_tuple(f_order{}, c_order{}, storage_f, shape_type{6}, shape_type{6,1}, std::vector<value_type>{1,1,1,1,1,1}),
        ...
        std::make_tuple(f_order{}, c_order{}, storage_f, shape_type{2,3}, shape_type{1,3}, std::vector<value_type>{1,2,3}),
        std::make_tuple(f_order{}, c_order{}, storage_f, shape_type{2,3}, shape_type{3,1,3}, std::vector<value_type>{1,2,3,1,2,3,1,2,3}),
        // //traverse f_order
        ...
        std::make_tuple(f_order{}, f_order{}, storage_f, shape_type{6}, shape_type{6,1}, std::vector<value_type>{1,1,1,1,1,1}),
        ...
        std::make_tuple(f_order{}, f_order{}, storage_f, shape_type{2,3}, shape_type{1,3}, std::vector<value_type>{1,2,3}),
        std::make_tuple(f_order{}, f_order{}, storage_f, shape_type{2,3}, shape_type{3,1,3}, std::vector<value_type>{1,1,1,2,2,2,3,3,3})
    );
