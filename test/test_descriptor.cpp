...
TEMPLATE_TEST_CASE("test_make_size_using_strides","[test_descriptor]",
    std::vector<std::int64_t>,
    std::vector<std::size_t>
)
{
    ...
    using test_type = typename std::tuple<shape_type,shape_type, index_type>;
    auto test_data = GENERATE(
        test_type{shape_type{},shape_type{},index_type{0}},
        test_type{shape_type{0},shape_type{1},index_type{0}},
        test_type{shape_type{1},shape_type{1},index_type{1}},
        test_type{shape_type{5},shape_type{1},index_type{5}},
        test_type{shape_type{1,1},shape_type{1,1},index_type{1}},
        test_type{shape_type{5,1},shape_type{1,1},index_type{5}},
        test_type{shape_type{1,5},shape_type{5,1},index_type{5}},
        test_type{shape_type{2,3,4},shape_type{12,4,1},index_type{24}}
    );
    auto shape = std::get<0>(test_data);
    auto strides = std::get<1>(test_data);
    auto size_expected = std::get<2>(test_data);
    auto size_result = make_size(shape,strides);
...
//             test_type(descriptor_type{shape_type{0}},shape_type{1},shape_type{},shape_type{},0,0),
