...
TEST_CASE("test_dispatcher","[test_dispatcher]"){
    ...
    SECTION("test_dispatcher"){
        ...
        using gtensor::detail::dispatcher;
        ...
        dispatcher<value_type,default_config, test_operation> test_dispatcher{test_operation{}};
        //result,expected_result
        auto test_data = GENERATE_REF(
            test_type{test_dispatcher.call(*t1,*t2),s_s},
            test_type{test_dispatcher.call(*t1,*e_trivial),s_t},
            test_type{test_dispatcher.call(*t1,*e),s_e},
            test_type{test_dispatcher.call(*t1,*ce_trivial),s_s},
            test_type{test_dispatcher.call(*t1,*ce),s_s},
            test_type{test_dispatcher.call(*t1,*v_of_t),s_s},
            test_type{test_dispatcher.call(*t1,*v_of_ce),s_s},
            test_type{test_dispatcher.call(*t1,*v_of_e),s_v},
            test_type{test_dispatcher.call(*t1,*v_of_v),s_v},
            
            test_type{test_dispatcher.call(*e_trivial,*t2),t_s},
            test_type{test_dispatcher.call(*e_trivial,*e_trivial),t_t},
            test_type{test_dispatcher.call(*e_trivial,*e),t_e},
            test_type{test_dispatcher.call(*e_trivial,*ce_trivial),t_s},
            test_type{test_dispatcher.call(*e_trivial,*ce),t_s},
            test_type{test_dispatcher.call(*e_trivial,*v_of_t),t_s},
            test_type{test_dispatcher.call(*e_trivial,*v_of_ce),t_s},
            test_type{test_dispatcher.call(*e_trivial,*v_of_e),t_v},
            test_type{test_dispatcher.call(*e_trivial,*v_of_v),t_v},
            
            test_type{test_dispatcher.call(*e,*t2),e_s},
            test_type{test_dispatcher.call(*e,*e_trivial),e_t},
            test_type{test_dispatcher.call(*e,*e),e_e},
            test_type{test_dispatcher.call(*e,*ce_trivial),e_s},
            test_type{test_dispatcher.call(*e,*ce),e_s},
            test_type{test_dispatcher.call(*e,*v_of_t),e_s},
            test_type{test_dispatcher.call(*e,*v_of_ce),e_s},
            test_type{test_dispatcher.call(*e,*v_of_e),e_v},
            test_type{test_dispatcher.call(*e,*v_of_v),e_v},
            
            test_type{test_dispatcher.call(*ce_trivial,*t2),s_s},
            test_type{test_dispatcher.call(*ce_trivial,*e_trivial),s_t},
            test_type{test_dispatcher.call(*ce_trivial,*e),s_e},
            test_type{test_dispatcher.call(*ce_trivial,*ce_trivial),s_s},
            test_type{test_dispatcher.call(*ce_trivial,*ce),s_s},
            test_type{test_dispatcher.call(*ce_trivial,*v_of_t),s_s},
            test_type{test_dispatcher.call(*ce_trivial,*v_of_ce),s_s},
            test_type{test_dispatcher.call(*ce_trivial,*v_of_e),s_v},
            test_type{test_dispatcher.call(*ce_trivial,*v_of_v),s_v},
            
            test_type{test_dispatcher.call(*ce,*t2),s_s},
            test_type{test_dispatcher.call(*ce,*e_trivial),s_t},
            test_type{test_dispatcher.call(*ce,*e),s_e},
            test_type{test_dispatcher.call(*ce,*ce_trivial),s_s},
            test_type{test_dispatcher.call(*ce,*ce),s_s},
            test_type{test_dispatcher.call(*ce,*v_of_t),s_s},
            test_type{test_dispatcher.call(*ce,*v_of_ce),s_s},
            test_type{test_dispatcher.call(*ce,*v_of_e),s_v},
            test_type{test_dispatcher.call(*ce,*v_of_v),s_v},
            
            test_type{test_dispatcher.call(*v_of_t,*t2),s_s},
            test_type{test_dispatcher.call(*v_of_t,*e_trivial),s_t},
            test_type{test_dispatcher.call(*v_of_t,*e),s_e},
            test_type{test_dispatcher.call(*v_of_t,*ce_trivial),s_s},
            test_type{test_dispatcher.call(*v_of_t,*ce),s_s},
            test_type{test_dispatcher.call(*v_of_t,*v_of_t),s_s},
            test_type{test_dispatcher.call(*v_of_t,*v_of_ce),s_s},
            test_type{test_dispatcher.call(*v_of_t,*v_of_e),s_v},
            test_type{test_dispatcher.call(*v_of_t,*v_of_v),s_v},
            
            test_type{test_dispatcher.call(*v_of_ce,*t2),s_s},
            test_type{test_dispatcher.call(*v_of_ce,*e_trivial),s_t},
            test_type{test_dispatcher.call(*v_of_ce,*e),s_e},
            test_type{test_dispatcher.call(*v_of_ce,*ce_trivial),s_s},
            test_type{test_dispatcher.call(*v_of_ce,*ce),s_s},
            test_type{test_dispatcher.call(*v_of_ce,*v_of_t),s_s},
            test_type{test_dispatcher.call(*v_of_ce,*v_of_ce),s_s},
            test_type{test_dispatcher.call(*v_of_ce,*v_of_e),s_v},
            test_type{test_dispatcher.call(*v_of_ce,*v_of_v),s_v},
            
            test_type{test_dispatcher.call(*v_of_e,*t2),v_s},
            test_type{test_dispatcher.call(*v_of_e,*e_trivial),v_t},
            test_type{test_dispatcher.call(*v_of_e,*e),v_e},
            test_type{test_dispatcher.call(*v_of_e,*ce_trivial),v_s},
            test_type{test_dispatcher.call(*v_of_e,*ce),v_s},
            test_type{test_dispatcher.call(*v_of_e,*v_of_t),v_s},
            test_type{test_dispatcher.call(*v_of_e,*v_of_ce),v_s},
            test_type{test_dispatcher.call(*v_of_e,*v_of_e),v_v},
            test_type{test_dispatcher.call(*v_of_e,*v_of_v),v_v},
            
            test_type{test_dispatcher.call(*v_of_v,*t2),v_s},
            test_type{test_dispatcher.call(*v_of_v,*e_trivial),v_t},
            test_type{test_dispatcher.call(*v_of_v,*e),v_e},
            test_type{test_dispatcher.call(*v_of_v,*ce_trivial),v_s},
            test_type{test_dispatcher.call(*v_of_v,*ce),v_s},
            test_type{test_dispatcher.call(*v_of_v,*v_of_t),v_s},
            test_type{test_dispatcher.call(*v_of_v,*v_of_ce),v_s},
            test_type{test_dispatcher.call(*v_of_v,*v_of_e),v_v},
            test_type{test_dispatcher.call(*v_of_v,*v_of_v),v_v}
        );
