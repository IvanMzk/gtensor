...
TEST_CASE("test_sort_search_argpartition_nth_container","[test_sort_search]")
{
    ...
    //no comparator
    REQUIRE(argpartition(tensor_type{},std::vector<int>{0,2,4},0,no_value{}) == tensor_type{});
    REQUIRE(argpartition(tensor_type{7,1,7,7,1,5,7,2,3,2,6,2,3,0},std::vector<int>{4},0,no_value{})(index_tensor_type{4}) == tensor_type{9});
    REQUIRE(argpartition(tensor_type{7,1,7,7,1,5,7,2,3,2,6,2,3,0},std::vector<int>{8,2,5},0,no_value{})(index_tensor_type{8,2,5}) == tensor_type{5,4,9});
    REQUIRE(argpartition(tensor_type{7,1,7,7,1,5,7,2,3,2,6,2,3,0},std::vector<int>{0,7,13},0,no_value{})(index_tensor_type{0,7,13}) == tensor_type{13,8,0});
    REQUIRE(
        ...
        tensor_type{{0,4,2,3,0},{3,3,3,4,3}}
    );
    REQUIRE(
        ...
        tensor_type{{1,4},{2,4},{2,3},{2,0},{0,3}}
    );
    REQUIRE(
        ...
        tensor_type{{1,2,4,0,1},{2,0,0,1,2},{4,1,1,2,4}}
    );
    REQUIRE(
        ...
        tensor_type{{3,2,0},{0,3,1},{1,0,4},{4,3,1},{2,1,4}}
    );
    //comparator
    REQUIRE(argpartition(tensor_type{7,1,7,7,1,5,7,2,3,2,6,2,3,0},std::vector<int>{8,2,5},0,std::greater<void>{})(index_tensor_type{8,2,5}) == tensor_type{7,2,5});
    REQUIRE(
        ...
        tensor_type{{4,1},{4,2},{3,2},{1,2},{3,4}}
    );
}
